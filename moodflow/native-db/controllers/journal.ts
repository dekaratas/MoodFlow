import { getAllJournals, createJournalEntry, deleteJournalEntry } from "../models/Journal"
...
export { getAllJournalsController, createJournalEntryController, deleteJournalEntryController }